...
%---------
\comentario{Proposta de dissertação de mestrado apresentada ao Programa de Pós-Graduação em Informática da Universidade Tecnológica Federal do Paraná -- UTFPR como requisito parcial para a obtenção do título de ``Mestre em Informática''.}
